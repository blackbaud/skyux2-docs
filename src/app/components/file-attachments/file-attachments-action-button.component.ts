  ...
  public routes = [
    {
      ...
      summary: 'The file attachment module creates options to attach multiple local files or link to external files.'
    },
    {
      ...
      icon: 'file-o',
      // tslint:disable-next-line
      summary: 'The single file attachment component creates a simple input to attach a single local file.'
    }
  ];
}
