  ...
  public getComponents(filter?: string): SkyDemoComponent[] {
    ...
    return [
      ...
      },
      {
        name: 'Tree view',
        icon: 'sitemap',
        summary: `The tree view module provides a hierarchical list view with multiple modes for selecting items.`,
        ...
        getCodeFiles: () => this.getDemoFiles('Angular tree view')
      },
      {
        name: 'URL validation',
        icon: 'check',
